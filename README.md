...
| Exp004 | Leave-One-Vendor-Out 实验 | 🏗️ 进行中 |
| Exp005 | 数据增强缓解方法 | 📋 计划中 |
...
### Exp004 — Vendor Shift 实验（结果待填写）

| Split | 训练 | 测试 | Avg Dice |
|---|---|---|---|
| 1 | Siemens | Philips | 待跑完 |
| 2 | Philips | Siemens | 待跑完 |
| 3 | Siemens+Philips | GE+Canon | 待跑完 |
| Mixed | 混合域（参照） | | 待跑完 |

**意义：** 如果 Split 3 Dice 明显低于 Mixed，证明跨厂商 domain shift 确实导致性能下降。
